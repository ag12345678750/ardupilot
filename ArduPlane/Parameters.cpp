...
const AP_Param::Info Plane::var_info[] =
        ...
        // @User: Advanced
                ...
                // @User: Advanced
                        GSCALAR(use_reverse_thrust, "USE_REV_THRUST",
                                USE_REVERSE_THRUST_AUTO_LAND_APPROACH),
                ...
                // @User: Standard
                        GSCALAR(nav_controller, "NAV_CONTROLLER",
                                AP_Navigation::CONTROLLER_L1),
                ...
                // @Values: 0:Automatic
                // @User: Advanced
                        GSCALAR(alt_control_algorithm, "ALT_CTRL_ALG",
                                ALT_CONTROL_DEFAULT),
                ...
                // @Increment: 1
                // @User: Standard
                        ASCALAR(pitch_limit_max_cd, "LIM_PITCH_MAX",
                ...
                // @Increment: 1
                // @User: Standard
                        ASCALAR(pitch_limit_min_cd, "LIM_PITCH_MIN",
                                PITCH_MIN_CENTIDEGREE),
                ...
                // @Range: -100 100
                // @User: User
                        GSCALAR(dspoiler_rud_rate, "DSPOILR_RUD_RATE",
                                DSPOILR_RUD_RATE_DEFAULT),
                ...
                { AP_PARAM_GROUP, "Q_A_",
                        Parameters::k_param_q_attitude_control,
                        (const void*) &plane.quadplane.attitude_control,
                        { group_info : AC_AttitudeControl_Multi::var_info },
...
// @Path: ../libraries/AP_Button/AP_Button.cpp
        ...
        // @Path: ../libraries/AP_Soaring/AP_Soaring.cpp
                AP_SUBGROUPINFO(soaring_controller, "SOAR_", 8, ParametersG2,
                        SoaringController),
...
ParametersG2::ParametersG2(void) :
        ice_control(plane.rpm_sensor, plane.ahrs), soaring_controller(
                plane.ahrs, plane.TECS_controller, plane.aparm) {
...
{ Parameters::k_param_battery_monitoring, 0, AP_PARAM_INT8, "BATT_MONITOR" },
        { Parameters::k_param_battery_volt_pin, 0, AP_PARAM_INT8,
                "BATT_VOLT_PIN" }, { Parameters::k_param_battery_curr_pin, 0,
                AP_PARAM_INT8, "BATT_CURR_PIN" }, {
                Parameters::k_param_volt_div_ratio, 0, AP_PARAM_FLOAT,
                "BATT_VOLT_MULT" }, { Parameters::k_param_curr_amp_per_volt, 0,
                AP_PARAM_FLOAT, "BATT_AMP_PERVOLT" }, {
                Parameters::k_param_curr_amp_offset, 0, AP_PARAM_FLOAT,
                "BATT_AMP_OFFSET" }, { Parameters::k_param_pack_capacity, 0,
                AP_PARAM_INT32, "BATT_CAPACITY" }, {
                Parameters::k_param_log_bitmask_old, 0, AP_PARAM_INT16,
                "LOG_BITMASK" }, { Parameters::k_param_rally_limit_km_old, 0,
                AP_PARAM_FLOAT, "RALLY_LIMIT_KM" }, {
                Parameters::k_param_rally_total_old, 0, AP_PARAM_INT8,
                "RALLY_TOTAL" }, { Parameters::k_param_serial0_baud, 0,
                AP_PARAM_INT16, "SERIAL0_BAUD" }, {
                Parameters::k_param_serial1_baud, 0, AP_PARAM_INT16,
                "SERIAL1_BAUD" }, { Parameters::k_param_serial2_baud, 0,
                AP_PARAM_INT16, "SERIAL2_BAUD" },
        ...
        { Parameters::k_param_land_slope_recalc_shallow_threshold, 0,
                AP_PARAM_FLOAT, "LAND_SLOPE_RCALC" }, {
                Parameters::k_param_land_slope_recalc_steep_threshold_to_abort,
                0, AP_PARAM_FLOAT, "LAND_ABORT_DEG" }, {
                Parameters::k_param_land_pitch_cd, 0, AP_PARAM_INT16,
                "LAND_PITCH_CD" }, { Parameters::k_param_land_flare_alt, 0,
                AP_PARAM_FLOAT, "LAND_FLARE_ALT" }, {
                Parameters::k_param_land_flare_sec, 0, AP_PARAM_FLOAT,
                "LAND_FLARE_SEC" }, { Parameters::k_param_land_pre_flare_sec, 0,
                AP_PARAM_FLOAT, "LAND_PF_SEC" }, {
                Parameters::k_param_land_pre_flare_alt, 0, AP_PARAM_FLOAT,
                "LAND_PF_ALT" }, { Parameters::k_param_land_pre_flare_airspeed,
                0, AP_PARAM_FLOAT, "LAND_PF_ARSPD" }, {
                Parameters::k_param_land_throttle_slewrate, 0, AP_PARAM_INT8,
                "LAND_THR_SLEW" }, { Parameters::k_param_land_disarm_delay, 0,
                AP_PARAM_INT8, "LAND_DISARMDELAY" }, {
                Parameters::k_param_land_then_servos_neutral, 0, AP_PARAM_INT8,
                "LAND_THEN_NEUTRAL" }, {
                Parameters::k_param_land_abort_throttle_enable, 0,
                AP_PARAM_INT8, "LAND_ABORT_THR" }, {
                Parameters::k_param_land_flap_percent, 0, AP_PARAM_INT8,
                "LAND_FLAP_PERCENT" },
...
void Plane::load_parameters(void) {
    ...
    const uint8_t old_rc_keys[14] = { Parameters::k_param_rc_1_old,
            Parameters::k_param_rc_2_old, Parameters::k_param_rc_3_old,
            Parameters::k_param_rc_4_old, Parameters::k_param_rc_5_old,
            Parameters::k_param_rc_6_old, Parameters::k_param_rc_7_old,
            Parameters::k_param_rc_8_old, Parameters::k_param_rc_9_old,
            Parameters::k_param_rc_10_old, Parameters::k_param_rc_11_old,
            Parameters::k_param_rc_12_old, Parameters::k_param_rc_13_old,
...
void Plane::convert_mixers(void) {
    ...
    AP_Param::ConversionInfo elevon_info = { Parameters::k_param_elevon_output,
            0, AP_PARAM_INT8, nullptr };
    AP_Param::ConversionInfo vtail_info = { Parameters::k_param_vtail_output, 0,
            AP_PARAM_INT8, nullptr };
    ...
    if (AP_Param::find_old_parameter(&vtail_info, &vtail_output)
            ...
            && !chan2->function_configured() && !chan4->function_configured()) {
        ...
        if (vtail_output < MIXING_UPUP_SWP) {
            ...
            && chan2->get_function() == SRV_Channel::k_elevator
            && !chan1->function_configured() && !chan2->function_configured()) {
