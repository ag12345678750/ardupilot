 ...
 */
AP_RangeFinder_Backend::AP_RangeFinder_Backend(RangeFinder &_ranger,
        uint8_t instance,
...
void AP_RangeFinder_Backend::update_status() {
    ...
    } else if ((int16_t) state.distance_cm
            < ranger._min_distance_cm[state.instance]) {
...
void AP_RangeFinder_Backend::set_status(
