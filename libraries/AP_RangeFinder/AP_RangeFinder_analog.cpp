 ...
 */
AP_RangeFinder_analog::AP_RangeFinder_analog(RangeFinder &_ranger,
...
void AP_RangeFinder_analog::update(void) {
    ...
    RangeFinder::RangeFinder_Function function =
            (RangeFinder::RangeFinder_Function) ranger._function[state.instance].get();
